      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          ...
          duration: 0.5
            ...
            <p className="text-lg text-gray-300">StriveX is an innovative multi-app studio that turns cutting-edge AI into intuitive mobile experiences—simplifying life, boosting productivity, and delighting users one intelligent app at a time.</p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            once: true
              ...
              <img src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?ixlib=rb-1.2.1&auto=format&fit=crop&w=870&q=80" alt="StriveX Team Collaboration" className="rounded-lg shadow-xl w-full" />
            </motion.div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          once: true
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto">
              At StriveX, we have core values that guide us in all our work.
            </p>
          </motion.div>
