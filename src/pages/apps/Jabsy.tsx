        ...
        <div className="mx-auto max-w-[95rem]">
          ...
          <div className="flex gap-6 justify-center flex-wrap lg:flex-nowrap pb-8">
            {screenshots.map((screenshot, index) => (
              ...
              >
                <div className="w-56 xl:w-64 rounded-3xl overflow-hidden shadow-2xl shadow-blue-500/20 border border-blue-500/20">
                  <img
                    src={screenshot.src}
                    alt={screenshot.alt}
                    className="w-full h-auto"
      ...
      <section className="py-8 px-4 border-t border-white/10">
        <div className="container mx-auto max-w-4xl">
          <div className="flex flex-wrap justify-center gap-6 text-sm text-gray-400">
            <Link to="/privacy-policy/glp-1-tracker" className="hover:text-white transition-colors">
              Privacy Policy
            </Link>
            <span className="text-gray-600">•</span>
            <Link to="/terms-conditions/glp-1-tracker" className="hover:text-white transition-colors">
              Terms & Conditions
            </Link>
          </div>
        </div>
