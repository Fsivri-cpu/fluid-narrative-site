...
const Index = () => {
  const featuredApps = [{
    ...
    rating: 4.9,
    category: "Business",
    gradient: "from-blue-700 to-amber-700",
    comingSoon: false,
    isDemo: true
  }];
  const stats = [{
  ...
  return <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-950 text-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-950/40 to-amber-700/20 backdrop-blur-3xl"></div>
        <div className="container mx-auto max-w-6xl relative z-10">
          ...
          duration: 0.8
            ...
            <h1 className="text-6xl md:text-8xl font-bold mb-6 bg-gradient-to-r from-blue-400 via-amber-500 to-blue-500 bg-clip-text text-transparent">
              StriveX
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
              <Link to="/apps">
                <Button size="lg" className="bg-gradient-to-r from-blue-600 to-amber-600 hover:from-blue-500 hover:to-amber-500 text-white px-8 py-4 text-lg">
                  Explore Our Apps
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            once: true
                ...
                <div className="w-16 h-16 mx-auto mb-6 bg-gradient-to-br from-blue-600 to-amber-600 rounded-2xl flex items-center justify-center">
