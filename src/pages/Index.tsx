...
const Index = () => {
  const featuredApps = [{
    ...
    rating: null,
    category: "Health",
    gradient: "from-blue-900 to-gray-300",
    comingSoon: true,
    ...
    rating: 4.9,
    category: "Business",
    gradient: "from-blue-800 to-gray-300",
    comingSoon: false,
    isDemo: true
  }];
  const stats = [{
  ...
  return <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-900/20 to-gray-300/20 backdrop-blur-3xl"></div>
        <div className="container mx-auto max-w-6xl relative z-10">
          ...
          duration: 0.8
            ...
            <h1 className="text-6xl md:text-8xl font-bold mb-6 bg-gradient-to-r from-blue-900 via-gray-300 to-blue-900 bg-clip-text text-transparent">
              StriveX
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
              <Link to="/apps">
                <Button size="lg" className="bg-gradient-to-r from-blue-900 to-gray-300 hover:from-blue-800 hover:to-gray-200 text-white px-8 py-4 text-lg">
                  Explore Our Apps
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            once: true
                ...
                <div className="w-16 h-16 mx-auto mb-6 bg-gradient-to-br from-blue-900 to-gray-300 rounded-2xl flex items-center justify-center">
