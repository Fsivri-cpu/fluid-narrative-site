        ...
        <div className="container mx-auto max-w-6xl">
          ...
          duration: 0.8
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-8">
              {categories.map(category => <Badge key={category} variant="outline" className="px-4 py-2 text-lg border-gray-500 text-white">
                  {category}
                </Badge>)}
            </div>
          </motion.div>
                  ...
                  <CardHeader className="pb-4">
                    <div className="flex items-start justify-between mb-4">
                       <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${app.primaryColor} flex items-center justify-center mb-4`}>
                         {app.icon ? <img src={app.icon} alt={app.name} className="w-full h-full object-cover rounded-2xl" /> : <Smartphone className="w-8 h-8 text-white" />}
                       </div>
                      {app.comingSoon && <Badge className="bg-yellow-500/20 text-yellow-300 border-yellow-500/30">
                          Coming Soon
                        </Badge>}
                    </div>
